...
- СЗ1: [Введение во Frontend](/module/1/lesson/1)
...
- СЗ6: [Работа с данными в браузере и производительность web-приложений, HTTP/2](/module/2/lesson/2)
- СЗ7: [Графика, разработка игр в браузере](/module/2/lesson/3)
